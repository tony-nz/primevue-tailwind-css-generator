...
:root {
  ...
  --surface-500: #71717a;
  --surface-600: #52525b;
  --surface-700: v-bind("getColor('text')");
  --surface-800: #27272a;
  --surface-900: #18181b;
  --gray-50: #fafafa;
  --gray-100: #f4f4f5;
...
@font-face {
  ...
  font-style: normal;
  font-weight: 300;
  src: local(""), url("./assets/fonts/Inter-Light.woff2") format("woff2"),
...
.p-speeddial-action {
  width: 3rem;
  height: 3rem;
  background: v-bind("getColor('text')");
  color: #fff;
}
...
.p-tooltip.p-tooltip-right .p-tooltip-arrow {
  border-right-color: v-bind("getColor('text')");
}

.p-tooltip.p-tooltip-left .p-tooltip-arrow {
  border-left-color: v-bind("getColor('text')");
}

.p-tooltip.p-tooltip-top .p-tooltip-arrow {
  border-top-color: v-bind("getColor('text')");
}

.p-tooltip.p-tooltip-bottom .p-tooltip-arrow {
  border-bottom-color: v-bind("getColor('text')");
}
